...
class Request(webob.Request):
    ...
    def best_match_content_type(self):
        ...
        if 'wormhole.best_content_type' not in self.environ:
...
class BaseApplication(object):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            [app:wadl]
            latest_version = 1.3
            paste.app_factory = wormhole.api.fancy_api:Wadl.factory

        which would result in a call to the `Wadl` class as

            import wormhole.api.fancy_api
...
class Middleware(BaseApplication):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            paste.filter_factory = wormhole.api.analytics:Analytics.factory

        which would result in a call to the `Analytics` class as

            import wormhole.api.analytics
...
class Loader(object):
    ...
    def load_app(self, name):
        ...
        :raises: `wormhole.exception.PasteAppNotFound`
